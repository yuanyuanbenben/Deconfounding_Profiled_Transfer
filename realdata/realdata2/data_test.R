...
load("NLSM_data_preprocessed.RData")
...
error_collect <- c(beta_t_l2_error,beta_t_l2_error_baseline1,beta_t_l2_error_baseline2,beta_t_l2_error_baseline3,beta_t_l2_error_baseline4,
                   eta_l2_error,eta_l2_error_baseline1,eta_l2_error_baseline2,eta_l2_error_baseline3,eta_l2_error_baseline4,eta_cate_error,
                   eta_cate_error_baseline1,eta_cate_error_baseline2,eta_cate_error_baseline3,eta_cate_error_baseline4)

print(error_collect)

write.csv(error_collect,'results.csv')
